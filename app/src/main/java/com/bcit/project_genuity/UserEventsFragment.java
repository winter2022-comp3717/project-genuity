...
public class UserEventsFragment extends Fragment {
    ...
    public static UserEventsFragment newInstance(Event param1) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView name = view.findViewById(R.id.user_event_title);
        TextView host = view.findViewById(R.id.user_event_host);
        TextView datetime = view.findViewById(R.id.user_event_datetime);
        TextView description = view.findViewById(R.id.user_event_description);
